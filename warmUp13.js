...
*/
//--------------     1    -----------------------------------------
function romToNum(roman){ // take roman number as string
	var value = {
		I: 1,
        V: 5,
        X: 10,
	...
	var array = roman.split('');
	 ...
	 for ( var i = 0; i < array.length; i++){
	 	total = total + value[array[i]];
	 }
	 return total;
}
//------------------------------------------------------------------
   3. In this kata you will create a function that takes a list of non-negative integers 
...
//--------------     3   -----------------------------------------
function filter(list){ // list is array non-negative integers and strings 
	var newArray = [];
	for( var i = 0; i < list.length; i++){
		if( list[i] isNaN ){
			list
		} else {newArray.push(list[i]);}
	}
